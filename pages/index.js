    ...
    <main className={styles.main}>
      ...
      <div>
        <div className={styles.input}>
          <div>
            <label htmlFor="image">{image ? <img src={image} alt="image" /> : "Click to select image"}</label>
            <input type="file" id="image" onChange={e => handleImageChange(e, setImage)} />
          </div>
          <button onClick={handleUpload}>Upload</button>
          <p>{uploadStatus}</p>
          <div className={styles.btns}>
            <button disabled={!imageId} onClick={handleCrop}>Crop</button>
            <button disabled={!imageId || !overlay} onClick={handleAddOverlay}>Add Overlay</button>
          </div>
          <div className={styles.overlay}>
            <label>Select Overlay</label>
            <input type="file" onChange={e => handleImageChange(e, setOverlay)} />
          </div>
        </div>
